...
urlpatterns = [
    ...
    path("categorias_buscar/", views.categorias_buscar, name="categorias_buscar"),
    ...
    path("productos_buscar/", views.productos_buscar, name="productos_buscar"),
    ...
    path("servicios_buscar/", views.servicios_buscar, name="servicios_buscar"),
    ...
    path("actualizar_contrasenas/", views.actualizar_contrasenas, name="actualizar_contrasenas"),
